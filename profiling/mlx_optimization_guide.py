...
""",
    ...
    def get_optimized_generation_config(
        ...
        return configs.get(hardware_profile, {}).get(
            use_case, configs["m2_max"]["chat"]
        )

    def apply_optimizations(
        self, mlx_manager: MLXManager, config: Dict[str, Any]
    ) -> None:
    ...
    def benchmark_optimizations(
        self, mlx_manager: MLXManager, prompt: str
    ) -> Dict[str, Any]:
    ...
    def get_model_recommendations(
        self, hardware_profile: str, memory_gb: int
    ) -> List[Dict[str, Any]]:
...
async def demo_optimizations():
    ...
    test_prompt = (
        "Explain the benefits of using MLX on Apple Silicon for machine learning."
    )
